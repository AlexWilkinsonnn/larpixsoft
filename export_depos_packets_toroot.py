...
from larpixsoft.funcs import get_events_vertex_cuts, get_events_no_cuts

def main(INPUT_FILES, N, OUTPUT_NAME, EXCLUDED_NUMS_FILE, VERTICES_FILE, PEDESTAL, SEGMENT_LENGTH, FAKE_FLUCTUATIONS, NO_CUTS):
...
#       segment_length = 0.04 # The max step length for LArG4 in [cm]
    ...
    for input_file in INPUT_FILES:
        ...
        if not VERTICES_FILE:
            ...
            try:
                vertex_dset = f['vertices']
            except KeyError:
                vertex_dset = f['eventTruth']

            for vertex in vertex_dset:
                vertices[vertex['eventID']] = (vertex['z_vert']/10.0, vertex['y_vert']/10.0, vertex['x_vert']/10.0, 0.0)
...
def parse_arguments():
    ...
    parser.add_argument("--no_cuts", action='store_true')

    args = parser.parse_args()

    return (args.input_files, args.n, args.o, args.excluded_nums_file, args.vertices, args.ped, args.segment_length, args.fake_fluctuations, args.no_cuts)
